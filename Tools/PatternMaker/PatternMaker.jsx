...
function ShowWindow() {
    ...
    win.dialog = win.add("panel", { width: 200, height: 60, x: 10, y: 20 }, "パターンになるレイヤー");
    ...
    win.dialog.btnP = win.dialog.add("button", { width: 15, height: 15, x: 0, y: 18 }, "↑");
    win.dialog.btnM = win.dialog.add("button", { width: 15, height: 15, x: 165, y: 18 }, "↓");
    ...
    win.dialog.btnP.onClick = function () {
        SelectLayer(true);
    }
    win.dialog.btnM.onClick = function () {
        SelectLayer(false);
    }
